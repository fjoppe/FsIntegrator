...
type CompareOperators = CompareOperation with
    (* All allowed combination of Equals operator *)
    static member CompareEquals (CompareOperation, l:StringMacro, r:string) = Equals(l,Literal(r))
    static member CompareEquals (CompareOperation, l:StringMacro, r:StringMacro) = Equals(l,r)
    static member CompareEquals (CompareOperation, l:IntegerMacro, r:int) = Equals(l,Int(r))
    static member CompareEquals (CompareOperation, l:IntegerMacro, r:IntegerMacro) = Equals(l,r)
    static member CompareEquals (CompareOperation, l:FloatMacro, r:float) = Equals(l,Float(r))
    static member CompareEquals (CompareOperation, l:FloatMacro, r:FloatMacro) = Equals(l,r)

    (* All allowed combination of Unequals operator *)
    static member CompareUnEquals (CompareOperation, l:StringMacro, r:string) = Unequals(l,Literal(r))
    static member CompareUnEquals (CompareOperation, l:StringMacro, r:StringMacro) = Unequals(l,r)
    static member CompareUnEquals (CompareOperation, l:IntegerMacro, r:int) = Unequals(l,Int(r))
    static member CompareUnEquals (CompareOperation, l:IntegerMacro, r:IntegerMacro) = Unequals(l,r)
    static member CompareUnEquals (CompareOperation, l:FloatMacro, r:float) = Unequals(l,Float(r))
    static member CompareUnEquals (CompareOperation, l:FloatMacro, r:FloatMacro) = Unequals(l,r)

    (* All allowed combination of LT operator *)
    static member CompareLT (CompareOperation, l:StringMacro, r:string) = LessThan(l,Literal(r))
    static member CompareLT (CompareOperation, l:StringMacro, r:StringMacro) = LessThan(l,r)
    static member CompareLT (CompareOperation, l:IntegerMacro, r:int) = LessThan(l,Int(r))
    static member CompareLT (CompareOperation, l:IntegerMacro, r:IntegerMacro) = LessThan(l,r)
    static member CompareLT (CompareOperation, l:FloatMacro, r:float) = LessThan(l,Float(r))
    static member CompareLT (CompareOperation, l:FloatMacro, r:FloatMacro) = LessThan(l,r)

    (* All allowed combination of GT operator *)
    static member CompareGT (CompareOperation, l:StringMacro, r:string) = GreaterThan(l,Literal(r))
    static member CompareGT (CompareOperation, l:StringMacro, r:StringMacro) = GreaterThan(l,r)
    static member CompareGT (CompareOperation, l:IntegerMacro, r:int) = GreaterThan(l,Int(r))
    static member CompareGT (CompareOperation, l:IntegerMacro, r:IntegerMacro) = GreaterThan(l,r)
    static member CompareGT (CompareOperation, l:FloatMacro, r:float) = GreaterThan(l,Float(r))
    static member CompareGT (CompareOperation, l:FloatMacro, r:FloatMacro) = GreaterThan(l,r)
